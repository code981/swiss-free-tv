...
const channels = [
  {
    ...
    language: 'DE',
    type: 'Official',
    description: 'Swiss public TV: news, culture, entertainment and live events. No public HLS stream available; view via official SRF website or mobile app.',
  ...
  },
  {
    ...
    language: 'DE',
    type: 'Official',
    description: 'Sports, documentaries, series and live specials from SRF. No public HLS stream available; view via official SRF website.',
